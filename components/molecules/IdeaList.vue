                ...
                {{ generatedIdea.description }}
							...
							<div class="-ml-px flex w-0 flex-1">
								...
								<a
									...
									target="_blank"
									class="relative inline-flex w-0 flex-1 cursor-pointer items-center justify-center rounded-br-lg border border-transparent py-4 text-sm font-medium text-green-800 hover:text-green-600"
...
const trackCustomEvent = () => {
	event('generated_idea_clicked', {
		event_category: 'custom',
		event_label: 'generated_idea_clicked',
	})
}
